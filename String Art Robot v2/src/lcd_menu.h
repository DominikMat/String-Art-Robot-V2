...
enum Screen {
    MAIN, PRINT_SELECT, PROGRESS, SENSORS, SETTINGS, CREDITS, COMPONENTS
};
...
void goBack();
void showAlert(std::string msg1, std::string msg2="", unsigned long durationMs = DEFALUT_ALERT_DURATION_MS);
